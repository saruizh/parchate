...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference("Comentario.count") do
      post comentarios_url, params: { comentario: { cuerpo: @comentario.cuerpo, id_plan: @comentario.id_plan, nickname: @comentario.nickname, rating: @comentario.rating } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { cuerpo: @comentario.cuerpo, id_plan: @comentario.id_plan, nickname: @comentario.nickname, rating: @comentario.rating } }
